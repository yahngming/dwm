...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_s,            spawn,             SHCMD("mkdir -p ~/Pictures/screenshots && maim --hidecursor --select ~/Pictures/screenshots/$(date '+%Y-%m-%d@%H:%M:%S').png | xclip -selection clipboard -target image/png") },
